            ...
            <div id="cv-container">
                ...
                <div class="cv-header">
                    <div class="download-cv">
                        <a href="img/Nohan GAGNOR.pdf" target="_blank">
                    ...
                    <div class="cv-contact">
                        <span class="cv-mail">nohangagnor@gmail.com</span>
                ...
                <div class="cv-content">
                    ...
                    <div class="cv-column cv-left">
                        <div class="cv-experiences">
                            ...
                            <div id="stageCnam">
                                <div class="cv-item">
                                    <div class="cv-header">
                                        <div class="cv-item-title"><h3>STAGE CNAM - BTS SIO</h3></div>
                                        <div class="cv-item-date">2026 - 5 sem.</div>
                                    </div>
                                    <div class="cv-item-subtitle">Stage d'observation en entreprise</div>
                                    <div class="cv-item-description">
                                        <p>Aide au développement d'une IHM pour la création de machines virtuelles</p>
                                        <ul>
                                            <li>Découverte des locaux et des différentes équipes</li>
                                            <li>Découverte du projet et des frameworks/bibliothèques utilisées</li>
                                            <li>Tuto framework Django (python)</li>
                                            <li>Implémentation d'aide à la saisie en javascript avec la bibliothèque Jquery</li>
                                            <li>création de tables en base de données avec Django</li>
                                            <li>Mise en forme de l'IHM (html/css)</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <!-- Colonne droite : Formation, Compétences, Langues -->
